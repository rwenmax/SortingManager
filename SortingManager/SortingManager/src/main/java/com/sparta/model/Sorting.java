...
public class Sorting {
    ...
    public static void calculateTime(String sort,long end, long start){
        long diff = end - start;
        if (diff >= 100000){
            double diffD = diff/1000000.0;
            if (diffD >= 100){
                diffD = diffD/1000.0;
                System.out.println(sort + ": " + diffD + " Seconds");
            }
            else{
                System.out.println(sort + ": " + diffD + " Miliseconds");
            }
        }
        else{
            System.out.println(sort + ": " + diff + " Nanoseconds");
        }
    }
}
